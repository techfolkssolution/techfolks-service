...
public class KycPassportController {
	...
	public ResponseEntity<?> kycPassportValidation(@RequestBody KycPassportValidation kycPassport) throws JsonMappingException, JsonProcessingException, MismatchedInputException {
		try {
