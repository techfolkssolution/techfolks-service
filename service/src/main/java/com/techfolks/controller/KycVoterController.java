...
public class KycVoterController {
	...
	@PostMapping("/voter")
	public ResponseEntity<?> kycVoterValidation(@Valid @RequestBody KycVoterValidation kycVoter) throws JsonMappingException, JsonProcessingException, MismatchedInputException {
		try {
